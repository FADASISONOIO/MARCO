...
P2 = [0 0;span/3 0 ; 0.7*span x(9) ;span x(10) ];
[~ , twist] = bezier_(P2 , noppoints , bezcurve(:,2));
...
fprintf(fid,'Planform\n#Mach\n0\n\n0 0 0\n\n0.078 0.0667 1.05\n\n0.0 0.0 0.0\n\nSURFACE\nMain\n10 -2 35 -2\n\nCOMPONENT\n1\n\nYDUPLICATE\n0.0\n\nSCALE\n0.001 0.001 0.001\n\nTRANSLATE\n0.0 0.0 0.0\n\nANGLE\n0\n\nCDCL\n-0.35 0.013 0.15 0.007 0.7 0.013\n\n');



for ii = 1:noppoints
    fprintf(fid,'SECTION \n');
    fprintf(fid, [num2str(bezcurve(ii,1) + qrlc(ii)) ' ' num2str(bezcurve(ii,2)) ' 0 ' num2str(chord(ii)) ' ' num2str(twist(ii))  ' \n']); 
    fprintf(fid,'AFILE\nmain.dat\n\n');
end
